...
impl Default for RequestId {
	fn default() -> Self { RequestId::Number(0) }
}
...
/// Tool definition struct (concrete type for tool definitions)
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Tool {
	pub Name:String,
...
impl Tool {
	pub fn new(Name:&str, Description:&str, InputSchema:serde_json::Value) -> Self {
		Self { Name:Name.to_string(), Description:Description.to_string(), InputSchema }
	}
}

/// Tool trait for MCP tools (alternative trait-based implementation)
...
impl RequestData {
	pub fn New(Method:Method) -> Self { Self { id:RequestId::default(), method:Method, params:None } }

	pub fn WithId(Method:Method, Id:RequestId) -> Self { Self { id:Id, method:Method, params:None } }

	pub fn WithParams(Method:Method, Params:serde_json::Value) -> Self {
		Self { id:RequestId::default(), method:Method, params:Some(Params) }
	}
}
