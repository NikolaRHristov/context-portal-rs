...
pub async fn List(
	...
	Query(_args):Query<ContextQueryArgs>,
...
pub async fn GetProductContext(
	...
	let context = DbOps::get_product_context(&conn).map_err(|e| crate::Error::Kind::Kind::Database(e))?;
...
pub async fn UpdateProductContext(
	...
	// Use database operation
	let context = DbOps::update_product_context(&conn, &args.workspace_id.clone().unwrap_or_default(), &args)
...
pub async fn GetActiveContext(
	...
	// Use database operation
	let context = DbOps::get_active_context(&conn).map_err(|e| crate::Error::Kind::Kind::Database(e))?;
...
pub async fn UpdateActiveContext(
	...
	// Use database operation
	let context = DbOps::update_active_context(&conn, &args.workspace_id.clone().unwrap_or_default(), &args)
		.map_err(|e| crate::Error::Kind::Kind::Database(e))?;
