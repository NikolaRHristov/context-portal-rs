...
impl HandleGetLinkedItems {
    pub async fn Execute(
        ...
        Ok(GetLinkedItemsResponse {
            Links,
            Total,
            SourceItemType: Payload.ItemType,
    ...
    async fn QueryLinks(
        ...
        tracing::debug!(
            "Querying links for {} {} in workspace {}",
            ItemType,
            ItemId,
            WorkspaceId
        );
...
mod tests {
    ...
    fn test_prevent_self_linking() {
        ...
        assert_eq!(Request.SourceItemId, Request.TargetItemId);
    }
}