...
use crate::HTTP::Protocol::Request::{Method, Request, RequestData, RequestId};
use crate::HTTP::Protocol::Response::{Error, ErrorCode, Response};
...
impl Stdio {
        ...
        F: FnMut(Request) -> Result<Value, Error> + Send + 'static,
    {
        ...
        // Call the handler
        match handler(Request::JsonRpc(RequestData::WithId(
            method,
            id.clone(),
        ))) {
...
impl StdioAsync {
    pub fn New() -> Self {
        ...
        Self {
            RequestTx: Some(request_tx),
            ResponseRx: Some(response_rx),
        }
    }
                ...
                Ok(line) => {
                    ...
                    match serde_json::from_str::<Request>(line) {
                        ...
                        Err(e) => {
                            ...
                            let response = Response::ParseError(RequestId::default(), &format!("JSON parse error: {}", e));
