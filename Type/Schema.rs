...
pub fn GetContextSchema() -> Value {
    serde_json::to_value(ContextSchema::default()).unwrap_or_default()
}

/// Get the decision JSON schema
pub fn GetDecisionSchema() -> Value {
    serde_json::to_value(DecisionSchema::default()).unwrap_or_default()
}

/// Get the progress JSON schema
pub fn GetProgressSchema() -> Value {
    serde_json::to_value(ProgressSchema::default()).unwrap_or_default()
}

/// Get the system pattern JSON schema
pub fn GetSystemPatternSchema() -> Value {
    serde_json::to_value(SystemPatternSchema::default()).unwrap_or_default()
}

/// Get the custom data JSON schema
pub fn GetCustomDataSchema() -> Value {
    serde_json::to_value(CustomDataSchema::default()).unwrap_or_default()
}

/// Get the context link JSON schema
pub fn GetContextLinkSchema() -> Value {
    serde_json::to_value(ContextLinkSchema::default()).unwrap_or_default()
}

/// Get all schemas combined
pub fn GetAllSchemas() -> Value {
    serde_json::to_value(AllSchemas::default()).unwrap_or_default()
}
