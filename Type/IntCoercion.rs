...
/// Visitor for deserializing integers that can come as either strings or numbers
struct IntVisitor<T> {
...
/// Helper for optional field coercion - returns None if string is empty or not digit-only
