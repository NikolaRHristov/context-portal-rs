...
pub mod item_type {
    ...
    pub fn all() -> Vec<&'static str> {
        vec![PRODUCT_CONTEXT, ACTIVE_CONTEXT]
    }
...
impl ContextHistory {
    ...
    pub fn content_from_json(json: &str) -> Value {
...
impl GetRecentActivitySummaryArgs {
    pub fn limit_per_type_value(&self) -> i64 {
        self.limit_per_type.unwrap_or(5)
    }
